-- Complete Migration Script: Drop Old Schema and Create New One
-- Run this single file to migrate from the old Padel schema to the new Football schema
...
-- Migration Complete!
-- ============================================
-- Your database is now ready for the football match booking app
